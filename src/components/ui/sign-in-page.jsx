            ...
            <motion.form
                ...
                <div className="p-8 pb-6 md:p-10">
                    ...
                    <div className="mt-6 space-y-5">
                        <div className="space-y-2">
                            ...
                            <Input type="email" required name="email" id="email-signin" placeholder="juan@ejemplo.com" />
                        </div>

                        <div className="space-y-2">
                            <div className="flex items-center justify-between">
                                <Label htmlFor="pwd-signin">Contraseña</Label>
                ...
                <div className="p-4 bg-white/5 border-t border-white/10 mt-2">
                    <p className="text-white/60 text-center text-sm">
                        ...
                        <button type="button" onClick={onRegisterClick} className="text-[#f99e02] hover:text-[#e08e02] font-semibold transition-colors bg-transparent border-none cursor-pointer p-0">
                            Regístrate
                        </button>
                    </p>
                </div>
